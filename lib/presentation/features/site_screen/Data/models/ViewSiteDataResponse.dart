...
class ViewSiteRefreshDataResponse{
  ...
  ViewSiteRefreshDataResponse({this.respCode, this.respMsg, this.leadStageEntity, this.leadStatusEntity, this.siteStageEntity,
    this.siteStatusEntity, this.siteSubTypeEntity, this.influencerCategoryEntity, this. srComplainResolutionEntity,
    this.srComplaintTypeEntity, this.siteOpportunityStatusEntity, this.siteProbabilityWinningEntity, this.srctRequestEntity, this.employeeDetails
  });
