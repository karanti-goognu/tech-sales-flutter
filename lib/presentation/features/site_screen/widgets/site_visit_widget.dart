...
//       }
//
//       if(widget.mwpVisitModel.remark == null || widget.mwpVisitModel.remark == "null"){
//         _remark = '';
//       }else{
//         _remark = widget.mwpVisitModel.remark;
//       }
  ...
  setData() {
    setState(() {
      ...
      if (viewSiteDataResponse.mwpVisitModel != null) {
        ...
        _selectedVisitType.text = viewSiteDataResponse.mwpVisitModel.visitType;
        selectedDateString = "${viewSiteDataResponse.mwpVisitModel.visitDate}";
      } else {
        // _siteTypeController.text = "";
      }
    });
