...
class SiteInfluencerWidgetState extends State<SiteInfluencerWidget> {
  ...
  setInfluencerData() {
    setState(() {
        ...
        for (int i = 0;
          ...
          _listInfluencerDetail!.add(new InfluencerDetail(
              ...
              id: new TextEditingController(
                  text:
                      viewSiteDataResponse!.influencerEntity![i].id.toString()),
      ...
      if (UpdatedValues.getSiteInfluencerDetails() != null &&
          UpdatedValues.getSiteInfluencerDetails()!.length > 0 &&
          (UpdatedValues.getSiteInfluencerDetails()!.length >=
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        if (_listInfluencerDetail != null &&
                            index >= _listInfluencerDetail!.length) {
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      // Text(
                                      //     "${widget.viewSiteDataResponse?.sitesModal!.isMemberAddded}"),
                                    (widget.viewSiteDataResponse?.sitesModal!
                                                .isMemberAddded ==
                                            "N")
                                        ? Switch(
                                            onChanged: (value) {
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Switch(
                                      onChanged: (value) {
                                        if (widget.viewSiteDataResponse
                                                ?.sitesModal!.isMemberAddded ==
                                            "N") {
                                          setState(() {
                                            if (value) {
                                              for (int i = 0;
                                ...
                                TextFormField(
                                  readOnly: (_listInfluencerDetail![index].isPrimary == "Y" &&
                                          widget.viewSiteDataResponse?.sitesModal!.isMemberAddded == "Y")
                                      ? true
                                      : false,
                                  ...
                                  onChanged: (value) async {
                                    ...
                                    if (value.length < 10) {
                                      ...
                                      print(":-:-:-$value");
                                      for (int i = 0; i < _listInfluencerDetail!.length - 1; i++) {
                                        print("for i=$i");
                                        if (value == _listInfluencerDetail![i].inflContact!.text) {
                                      ...
                                      if (match) {
                                        Get.dialog(CustomDialogs.showMessage("Already added influencer : " + value));
