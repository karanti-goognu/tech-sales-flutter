...
class _VisitDataViewState extends State<VisitDataView> {
  ...
  TextEditingController _siteCurrentTotalBags = new TextEditingController();
      ...
      child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField(
              ...
              items: ['IHB', 'Dealer', 'SUBDEALER', 'SALESOFFICER']
            ...
            DropdownButtonFormField(
              validator: (value) =>
                  value == null ? 'Please select Sub-Dealer' : null,
              onChanged: (value) {},
              items: ['IHB', 'Dealer', 'SUBDEALER', 'SALESOFFICER']
                  .map((e) => DropdownMenuItem(
                        child: Text(
              ...
              child: Padding(
                ...
                child: TextFormField(
                  ...
                  style: TextStyle(
                      ...
                      fontFamily: "Muli"),
                  keyboardType: TextInputType.text,
                  decoration: FormFieldStyle.buildInputDecoration(labelText: "Date ",
                    suffixIcon: IconButton(
                      icon: Icon(
                        Icons.date_range_rounded,
                        size: 22,
