                                                                  ...
                                                                  child: Padding(
                                                                      ...
                                                                      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                        ...
                                                                        Text(
                                                                            "Closed",
                                                                            style:
                                                                                TextStyle(fontSize: 30, color: HexColor("#B00020"))),
                                                                        SizedBox(
                                                                          height:
                                                                              MediaQuery.of(context).size.height * 0.03,
                                                                        ),
                                                                        Center(
                                                                            child: Text("Please add your comment to complete this rejection",
                                                                                maxLines: 2,
                                                                        ...
                                                                        Center(
                                                                            child: ElevatedButton(
                                                                                ...
                                                                                onPressed: () async {
                                                                                  if (closureReasonText.text != null && closureReasonText.text != "") {
                                                                                    _siteStage = value;
                                                                      ...
                                                                      suffixIcon:
                                                                        ...
                                                                        icon:
                                                                          ...
                                                                          size:
                                                                              22,
                                                                          color:
                                                                              ColorConstants.clearAllTextColor,
                                                                        ),
                                                                        onPressed:
                                                                            () async {
                                                                          print(
                ...
                if (snapshot.hasError)
                  ...
                  return TabBarView(
                      ...
                      SiteVisitWidget(
                       ...
                       //      _siteOpportunitStatusEnityVisit,
                       // // visitRemarks: snapshot.data.sitesModal.siteClosureReasonText,
                       //    viewSiteDataResponse: snapshot.data
                      )
                    ],
