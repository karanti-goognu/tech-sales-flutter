...
class _LogsViewState extends State<ViewLogs> {
  ...
  addDateForGiftsView() async {
    ...
    _giftCategoriesList = [];
    _giftsCategoriesValueList = [
      giftController.giftStockModelList[giftController.selectedDropdown]
          .giftOpeningStockQty,
      giftController
          .giftStockModelList[giftController.selectedDropdown].giftInHandQty,
      giftController
          .giftStockModelList[giftController.selectedDropdown].giftUtilisedQty
    ];
  ...
  getDetailEventsData() async {
    await giftController.getGiftStockData().then((data) {
      giftController
          .getViewLogsData1(giftController.giftStockModelList)
          .then((value) => {
                setState(() {
  ...
  void initState() {
    getDetailEventsData();
    giftController
        .getViewLogsData("${giftController.monthYear}")
        .then((value) => {});
    super.initState();
  }
                              ...
                              child: TextButton(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Obx(
                                      () => Text(
                                        giftController.monthYear.toString(),
                                ...
                                onPressed: () {
                                  ...
                                  showMonthPicker(
                                    ...
                                    if (date != null) {
                                      ...
                                      giftController.monthYear =
                                          '$_currentMonth-${date.year.toString().substring(2)}';
                                      //  print(giftController.monthYear);
                                      giftController.getViewLogsData(
                                          giftController.monthYear.toString());
                                    }
                                  });
                                },
                            ...
                            child: Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: GetBuilder<GiftController>(
                                    builder: (cc) => DropdownButton(
                                      onChanged: (dynamic newValue) {
                                        giftController.selectedDropdown =
                                            newValue;
                                        cc.update();
                                        giftController
                                            .getGiftStockData()
                        ...
                        child: ListView.separated(
                            ...
                            separatorBuilder: (context, index) {
                              return giftController
                                          .dataForViewLog[index].giftTypeId !=
                                      giftController.selectedDropdown
                                  ? Container()
                                  : SizedBox(
                                      height: 15,
                                                                  ...
                                                                  index == 1
                                                                      ...
                                                                      : index ==
                                                                          ...
                                                                          ? giftController
                                                                              ...
                                                                              .toString()
                                                                          : index == 3
                                                                              ? giftController.dataForViewLog[i].giftUtilisedQty.toString()
                                                                              : "",
                                                                  style:
                                                                      TextStyle(
                                                                    fontWeight:
