...
class _EventSearchState extends State<EventSearch> {
  ...
  _color(int? id) {
    switch (id) {
      case 1:
        return HexColor('#F9A61A');
      case 2:
        return HexColor('#39B54A');
      case 3:
        return HexColor('#B00020');
      case 4:
        return HexColor('#39B54A');
      case 5:
        return HexColor('#B00020');
  ...
  Widget eventsDetailWidget() {
    return Obx(() => _eventController.dataForSearchResult.eventListModels ==
            null
        ? Container()
        : ListView.builder(
            padding: const EdgeInsets.only(left: 6.0, right: 6, bottom: 8),
            itemCount:
                _eventController.dataForSearchResult.eventListModels.length,
            itemBuilder: (context, index) {
              return GestureDetector(
                onTap: () {
                  if (_eventController.dataForSearchResult
                          .eventListModels[index].eventStatusText ==
                      StringConstants.approved) {
                    Get.to(
                        () => DetailViewEvent(_eventController
                            .dataForSearchResult
                            .eventListModels[index]
                            .eventId),
                        binding: EGBinding());
                  } else if (_eventController.dataForSearchResult
                          .eventListModels[index].eventStatusText ==
                    ...
                    Get.to(() => EndEvent(
                        _eventController
                            .dataForSearchResult.eventListModels[index].eventId,
                        2));
                  } else if (_eventController.dataForSearchResult
                          .eventListModels[index].eventStatusText ==
                    ...
                    Get.to(
                        () => DetailPending(
                            _eventController.dataForSearchResult
                                .eventListModels[index].eventId,
                            ColorConstants.eventPending),
                        binding: EGBinding());
                  } else if (_eventController.dataForSearchResult
                          .eventListModels[index].eventStatusText ==
                    ...
                    Get.to(
                        () => DetailPending(
                            _eventController.dataForSearchResult
                                .eventListModels[index].eventId,
                            ColorConstants.eventNotSubmited),
                        binding: EGBinding());
                  } else {}
                },
                child: Card(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      border: Border(
                          left: BorderSide(
                        color: _color(_eventController.dataForSearchResult
                            .eventListModels[index].eventStatusId),
                        width: 6,
                      )),
                    ),
                    child: Padding(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Chip(
                                shape: StadiumBorder(
                                    side: BorderSide(
                                        color: _color(_eventController
                                            .dataForSearchResult
                                            .eventListModels[index]
                                            .eventStatusId))),
                                backgroundColor: _color(_eventController
                                        .dataForSearchResult
                                        .eventListModels[index]
                                        .eventStatusId)
                                    .withOpacity(0.2),
