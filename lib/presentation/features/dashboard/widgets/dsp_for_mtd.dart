        ...
        child: _currentMothDspSlabVolume == false
                      ...
                      DoughnutSeries<ChartDataForMTD, String>(
                          dataSource: [
                            ChartDataForMTD(
                                ...
                                _dashboardController.dspTotalOpperCount
                                    .toDouble(),
                                Color(0xff39B54A)),
                            ChartDataForMTD(
                            ...
                            ChartDataForMTD(
                                ...
                                _dashboardController.dspSlabConvertedCount
                                    .toDouble(),
                                Color(0xff007CBF)),
                            ChartDataForMTD(
                                'Remaining Tgt-${_dashboardController.dspRemaingTargetCount}',
                                _dashboardController.dspRemaingTargetCount
                                    .toDouble(),
                                Color(0xffFFCD00)),
                          ],
                          innerRadius: '65.0',
                          pointColorMapper: (ChartDataForMTD data, _) =>
                              data.color,
            ...
            : Obx(() => Column(
                  children: [
                    Expanded(
                      flex: 9,
                      child: _dashboardController.dspTotalOpperVolume == 0
                          ? Center(
                              child: Text("Target is not yet set"),
                            )
                          : SfRadialGauge(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                child: Container(
                                  child: Text(
                                    "Opportunity-${_dashboardController.dspTotalOpperVolume} MT",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        fontSize:
