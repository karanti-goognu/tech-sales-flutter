...
class _SiteSearchScreenState extends State<SiteSearchScreen> {
  ...
  AppController _appController = Get.find();
   ...
   SitesDBProvider model;


  fetchFilterData(String  contactNumber){
    if (contactNumber != null && contactNumber!="") {
      model.searchSiteList(contactNumber);
      model.fetchAllSites1().then((value) => {
  ...
  void initState() {
    ...
    model = ScopedModel.of(this.context);
    // getUserDetails();
  }
  ...
  Widget leadsDetailWidget1(SitesDBProvider model) {
    return FutureBuilder<List<SitesModal>>(
