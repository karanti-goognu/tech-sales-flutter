...
class UpdateServiceRequestController extends GetxController{
  ...
  getAccessKeyAndUpdateRequest(List<File> imageList, UpdateSRModel updateRequestModel) {
    ...
    repository.getAccessKey().then((data) async{
      ...
      await _prefs.then((SharedPreferences prefs) async {
        ...
        updateServiceRequest(imageList, data.accessKey, userSecurityKey, updateRequestModel).then((value){
          Get.back();
  ...
  Future<Map> updateServiceRequest(List<File> imageList, String accessKey, String userSecurityKey,UpdateSRModel updateRequestModel){
    return repository.updateServiceRequest(imageList, accessKey, userSecurityKey, updateRequestModel).whenComplete(() => responseForDialog ='Test');
  }
}