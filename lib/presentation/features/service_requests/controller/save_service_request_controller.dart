...
class SaveServiceRequestController extends GetxController{
  ...
  getAccessKeyAndSaveRequest(List<File> imageList, SaveServiceRequest saveRequestModel) {
    ...
    repository.getAccessKey().then((data) async{
      ...
      await _prefs.then((SharedPreferences prefs) async {
        ...
        saveServiceRequest(imageList, data.accessKey, userSecurityKey, saveRequestModel);
  ...
  saveServiceRequest(List<File> imageList, String accessKey, String userSecurityKey,SaveServiceRequest saveRequestModel){

    repository.saveServiceRequest(imageList, accessKey, userSecurityKey, saveRequestModel).whenComplete(() => responseForDialog ='Test');
