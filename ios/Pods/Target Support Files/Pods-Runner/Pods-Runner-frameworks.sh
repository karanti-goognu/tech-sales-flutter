...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MoEPluginBase/MoEPluginBase.framework"
  ...
  install_framework "${PODS_ROOT}/MoEngageInApp/Frameworks/MOInApp.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/moengage_flutter/moengage_flutter.framework"
